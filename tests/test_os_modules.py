...
class SshModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.ssh import SshKeyEntry, SshModule, SshResult, SshSetting
...
class CronModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.cron import CronDirEntry, CronEntry, CronModule, CronResult
...
class SystemdModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.systemd import SystemdModule, SystemdResult, SystemdServiceEntry, TimerEntry
...
class DockerModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.docker import DockerContainerInfo, DockerModule, DockerResult
...
class KernelModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.kernel import KernelModule, KernelResult, LoadedKernelModule, SysctlSetting
...
class EnvironmentModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.environment import EnvironmentModule, EnvironmentResult, EnvVariable, PathEntry
...
class ProcessesModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.processes import ProcessesModule, ProcessesResult, ProcessInfo
...
class PackagesModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.packages import AptSourceEntry, InstalledPackage, PackagesModule, PackagesResult
...
class LogsModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.logs import LogEntry, LogsModule, LogsResult, LogStatistics
...
class SecretsModuleTests(unittest.TestCase):
    def test_import(self) -> None:
        from vina.scanners.os.secrets import SecretFile, SecretsModule, SecretsResult
