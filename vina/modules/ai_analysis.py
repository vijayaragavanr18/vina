...
from ..models.common import AnalysisItem, ParameterCandidate, PortEntry, TechnologyEntry
        ...
        if parameters:
            items.append(
                AnalysisItem(
                    ...
                    manual_verification=[
                        "Check reflected input and parameter handling in Burp.",
                        "Map allowed methods and auth boundaries.",
                    ],
        ...
        if ports:
            items.append(
                AnalysisItem(
                    ...
                    manual_verification=[
                        "Confirm which ports are truly required.",
                        "Check for version disclosure and default configurations.",
                    ],
                )
            )
        if technologies:
            items.append(
                AnalysisItem(
                    ...
                    manual_verification=[
                        "Check whether the fingerprint is accurate.",
                        "Review version-specific advisories manually.",
                    ],
                )
            )
        return items
